...
<img
  ...
  src="/images/JavascriptWorkings/CreationPhase1.png"
  alt="Creation Phase 1"
/>
...
<img
  className="block rounded-lg w-full"
  src="/images/JavascriptWorkings/CreationPhase2.png"
  alt="Creation Phase 2"
/>
...
<img
  className="block rounded-lg w-full"
  src="/images/JavascriptWorkings/ExecutionPhase1.png"
  alt="Execution Phase 1"
/>
...
<img
  className="block rounded-lg w-full"
  src="/images/JavascriptWorkings/ExecutionPhase2.png"
  alt="Execution Phase 2"
/>
...
<img
  className="block rounded-lg w-full"
  src="/images/JavascriptWorkings/ExecutionPhase3.png"
  alt="Execution Phase 3"
/>
